...
filename=append('C:\Users\tanaka\Documents\phase-field_1d_results\2023.03.29.15.41\sig\sig_',filenum);
data=load(filename);
...
video=VideoWriter('C:\Users\tanaka\Documents\phase-field_1d_results\2023.03.29.15.41\sig.mp4','MPEG-4');
video.Quality=100;
video.FrameRate=160;
open(video);
...
filenum=sprintf('%04u0',i);
filename=append('C:\Users\tanaka\Documents\phase-field_1d_results\2023.03.29.15.41\c\c_',filenum);
data=load(filename);
plot(data(:,1),data(:,2));
xlim([0       0.100000000000E+00]);
ylim([-0.01 1.01]);
...
video=VideoWriter('C:\Users\tanaka\Documents\phase-field_1d_results\2023.03.29.15.41\c.mp4','MPEG-4');
video.Quality=100;
video.FrameRate=160;
open(video);
writeVideo(video,frames);
...
clear;
fig=figure;
filename=append('C:\Users\tanaka\Documents\phase-field_1d_results\2023.03.29.15.41\energy');
data_1=load(filename);
filename=append('C:\Users\tanaka\Documents\phase-field_1d_results\2023.03.29.15.41\energy_total');
...
drawnow;
print(fig,'-djpeg','C:\Users\tanaka\Documents\phase-field_1d_results\2023.03.29.15.41\energy.jpg','-r600');
...
for i=0:n_5
filenum=sprintf('%04u0',i);
filename=append('C:\Users\tanaka\Documents\phase-field_1d_results\2023.03.29.15.41\u\u_',filenum);
data=load(filename);
sig(i+1,1)=data(          51,2);
filename=append('C:\Users\tanaka\Documents\phase-field_1d_results\2023.03.29.15.41\sig\sig_',filenum);
data=load(filename);
...
colororder(newcolors);
drawnow;
name='C:\Users\tanaka\Documents\phase-field_1d_results\2023.03.29.15.41';
